...
namespace Greab_Alexandra_lab2.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Greab_Alexandra_lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Greab_Alexandra_lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
